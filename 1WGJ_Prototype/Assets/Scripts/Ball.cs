...
public class Ball : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (ballState == BALL_STATE.GREEN) StateAndColorSetter(BALL_STATE.RED);
            else if (ballState == BALL_STATE.BLUE) StateAndColorSetter(BALL_STATE.GREEN);
            else if (ballState == BALL_STATE.RED)
            {
                Destroy(gameObject);
            }
